...
status = (status = ($.getval("zgdxstatus") || "1")) > 1 ? `${status}` : "";

let statuc;

statuc = (statuc = ($.getval("dxwsstatuc") || "1")) > 1 ? `${statuc}` : "";

const zgdxbodyArr = [], dxwsbodyArr = [], dxwscount = '', zgdxcount = ''

let zgdxbody = $.getdata('zgdxbody')
...
!(async () => {
    ...
    if (typeof $request !== "undefined") {
        ...
        zgdxbodyArr.push($.getdata('zgdxbody'))

        let zgdxcount = ($.getval('zgdxcount') || '1');

        for (let i = 2; i <= zgdxcount; i++) {

            zgdxbodyArr.push($.getdata(`zgdxbody${i}`))
        ...
        for (let i = 0; i < zgdxbodyArr.length; i++) {

            if (zgdxbodyArr[i]) {

                zgdxbody = zgdxbodyArr[i];
